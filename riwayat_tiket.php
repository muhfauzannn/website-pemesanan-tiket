...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $sql = "SELECT * FROM tiket_display WHERE tujuan LIKE '%$search%'";
} else {
    $sql = "SELECT * FROM tiket_display";
}
...
<body>
    <div class="search-container">
        <div class="search">
            <form action="riwayat_tiket.php" method="GET">
        ...
        <div class="content-dashboard">
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo '        <img src="./assets/qr-scan.png">';
                    echo '    </div>';
                    ...
                    echo '        </div>';
                    echo '        <form action="./function/sukses_pesan_tiket.php" method="GET">';
                    echo '            <input type="hidden" name="kd_tiket" value="' . $row["kd"] . '">';
                    echo '            <input type="submit" value="Detail" id="cek-tiket">';
                    echo '        </form>';
                    echo '    </div>';
                    echo '</div>';
                }
